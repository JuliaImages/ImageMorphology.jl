...
let grp = SUITE["leveling"]
    ...
    grp["low_leveling"] = @benchmarkable low_leveling(cameraman,$gaus,trues(3,3))
    grp["high_leveling"] = @benchmarkable high_leveling(cameraman,$gaus,trues(3,3))
    grp["leveling"] = @benchmarkable leveling(cameraman,$gaus,trues(3,3))
end